...
# Load model (relative to this script)
SCRIPT_DIR = Path(__file__).parent
MODEL_PATH = SCRIPT_DIR.parent.parent / "models" / "wildfire_readiness_rf_model.joblib"

if not MODEL_PATH.exists():
    raise FileNotFoundError(
        f"Model file not found: {MODEL_PATH}\n"
        "Please run the model export cell in the notebook first."
    )
